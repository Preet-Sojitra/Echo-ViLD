...
def main(args):
    ...
    print(f"\nGenerating descriptions for {len(COCO_CATEGORIES)} COCO categories...\n")
    for cat_id, cat_name in tqdm(COCO_CATEGORIES.items()):
    ...
    json_path = f"{args.output_dir}/coco_descriptions.json"
